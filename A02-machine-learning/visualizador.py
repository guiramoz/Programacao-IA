...
with col1:
    tempo = st.number_input("Tempo de contrato (meses)", min_value = 1, value = 14, max_value = 200)
...
#probabilidade < 70%
    if probabilidade > 0.7:
        ...
        st.info("*Sugestão de ação:* Oferecer cupom de fidelidade FID210350OFF")
